...
def main():
    ...
    # TODO CHANGE HOW WE LOAD DATASETS (we want cifar100)
    ...
    # NEEDS TO RUN THIS BEFORE TESTING THE NEURAL COLLAPSE PHENOMENA
    model.fc.register_forward_pre_hook(fc_features) # runs before the forward pass of the fc layer (fc_feature(module, inputs)), and saves the input to fc_features
    # HERE WE HAVE TO DO IT FOR THE 2nd head if there is 
